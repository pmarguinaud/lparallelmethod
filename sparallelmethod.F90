...
WRITE (0, *) __FILE__, ':', __LINE__, " CLMETHOD = ", CLMETHOD

IF (CDMETHOD (1:1) /= ' ') THEN
  LPARALLELMETHOD = EQUAL (CLMETHOD, CDMETHOD)
  RETURN
ENDIF

LPARALLELMETHOD = EQUAL (CDMETHOD, "OPENMP") .OR. EQUAL (CDMETHOD, "OPENMPMETHOD")
